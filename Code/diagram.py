"""
plot_causal_tracing.py
Three plots:
  1. Line plot — baseline vs patched source rate per direction
  2. Delta line plot — causal effect (patched - baseline)
  3. Heatmap — baseline | patched side by side
"""
