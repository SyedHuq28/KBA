"""
3_layer_probe_sweep.py
All-layer linear probe sweep on hidden (H) and MLP (M) spaces.
Output:
  results/layer_probe_hidden.json   — per-layer val acc + F1
  results/layer_probe_mlp.json      — same for MLP space
  results/band_probe_hidden.json    — consecutive 2-layer band probes
"""
