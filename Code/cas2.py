#!/usr/bin/env python3
"""
9_causal_patching.py  —  Causal Tracing from Best Probe Layer (GPU router inference)

Patches the best layer (from script 3 probe sweep) and reads the
per-layer router prediction at every layer AFTER the patch site.

Outputs:
  results/causal_tracing_<split>.json
  results/causal_tracing_<split>_compact.json
"""
