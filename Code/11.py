"""
11_train_sad_models.py
Train classifiers on SAD features produced by 10_sad_reextract_all_layers.py.

Trains/evaluates:
A) Mean SAD (7 dims)                   -> "sad_mean"
B) All-layer SAD concat (7*L dims)     -> "sad_all_concat"
C) Best single-layer SAD (auto on val) -> "sad_best_layer"

Outputs:
- results/sad_models_summary.json
"""
