"""
prompts.py — Shared prompt template library + frozen decoding config.

Scientific prompt suite (P0–P5) with controlled, hypothesis-driven perturbations:
  - P0: Baseline (grounding + explicit doc boundaries, docs-first)
  - P1: Instruction paraphrase only (structure unchanged)
  - P2: Boundary tokenization change only (instruction unchanged)
  - P3: No system grounding (tests dependence on explicit instruction)
  - P4: Question-first ordering (position sensitivity)
  - P5: Structured wrapper (format robustness)

CONVENTION: render_prompt always joins non-empty parts with "\n\n".
"""
