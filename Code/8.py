"""
8_prompt_dependence.py
Prompt-dependence evaluation: train on P0 → evaluate on P1–P5.

Fix 5: augmented training section removed from here.
       "Train on P0, test on P1–P5" is the publishable claim.
       If you later extract P1–P5 train activations, run with --augmented.

Usage:
  python 8_prompt_dependence.py
  python 8_prompt_dependence.py --augmented   # only if P1-P5 train npy exist
"""
